...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/api/race/getComments").permitAll()
                .antMatchers("/api/race/delete").permitAll()
                .antMatchers("/api/bets/").permitAll()
                // .antMatchers("/api/user/makeBet").permitAll()
                // .antMatchers("/api/user/deleteBet").permitAll()
                .antMatchers("/api/user/getBets/*").permitAll()
                .antMatchers("/api/race/raceResults").permitAll()
                .antMatchers("/api/race/customRace").hasAnyAuthority("Admin", "Coach")
                // .antMatchers("/api/race/declareWinner").permitAll()
                // .antMatchers("/api/race/*").permitAll()
                // .antMatchers("/api/user/updateBet").permitAll()
                // .antMatchers("/api/user/processBets").permitAll()
